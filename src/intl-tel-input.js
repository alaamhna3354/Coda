    ...
    var Iti = class {
      ...
      _bindDropdownListeners() {
        this._handleMouseoverCountryList = (e) => {
          const listItem = e.target ? e.target.closest(".iti__country") : null;
          if (listItem) {
        ...
        this._handleClickCountryList = (e) => {
          const listItem = e.target && e.target.closest(".iti__country");
          if (listItem) {
      ...
      _handleUpDownKey(key) {
        let next = key === "ArrowUp" ? (this.highlightedItem && this.highlightedItem.previousElementSibling) : (this.highlightedItem && this.highlightedItem.nextElementSibling);      if (!next && this.countryList.childElementCount > 1) {
      ...
      setCountry(iso2) {
        const iso2Lower = iso2 ? iso2.toLowerCase() : null;
